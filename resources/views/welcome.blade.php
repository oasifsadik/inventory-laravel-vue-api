  ...
  <div id="wrapper">
    ...
    <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display: none;">
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            <router-link
             class="sidebar-brand d-flex align-items-center justify-content-center" to="/home">
            ...
            <li class="nav-item">
              ...
              <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  {{-- <a class="collapse-item" href="alerts.html">Add Employee</a>
                  <a class="collapse-item" href="buttons.html">All Employee</a> --}}
                </div>
              </div>
            </li>
            <li class="nav-item">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Footer -->
      <footer class="sticky-footer bg-white" id="foter" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display: none;">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="jida" target="_blank">Oasif Sadik Jisan</a></b>
            </span>
          </div>
        </div>
      </footer>
